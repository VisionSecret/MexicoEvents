...
const SupplierCard = ({ supplier }) => {
  return (
    <div
      className="supplier-card group bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-md hover:shadow-lg transition-all border border-transparent hover:border-[#4E2DB310] hover:scale-105"
    >
